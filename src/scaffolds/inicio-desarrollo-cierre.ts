import type { Bloque, BloqueHijo, Target } from "../schema/clase";
...
/**
 * Scaffold "Inicio / Desarrollo / Cierre": secuencia socioconstructivista con
 * método PBL para primaria. La semilla trae contenido placeholder y notas guía
 * que explican la intención pedagógica de cada momento.
 */
