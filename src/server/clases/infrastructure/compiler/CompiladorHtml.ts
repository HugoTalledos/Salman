...
import type { Bloque, BloqueHijo, ClaseSalman } from "../../domain/entity/Clase";
import type {
  CompiladorClase,
  TargetCompilacion,
} from "../../domain/service/CompiladorClase";
import { escaparHtml, lineaAHtml, mdAHtml } from "./Markdown";
export { ARCHIVO_POR_TARGET } from "../../application/useCase/CompilarProyecto";
...
export function compilarClaseComoHtml(
  clase: ClaseSalman,
  doc: TargetCompilacion,
): string {
...
export class CompiladorHtml implements CompiladorClase {
  compilar(clase: ClaseSalman, target: TargetCompilacion): string {
    return compilarClaseComoHtml(clase, target);
  }
}
